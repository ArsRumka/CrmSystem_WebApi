...
## 13. Следующий рекомендуемый модуль

Следующий рекомендуемый модуль после Catalog: **Deals**.

Причины:

- Deals смогут использовать `Client` из Clients;
- Deals смогут использовать `Product` и `Service` из Catalog;
- будущие pricing/discount calculations естественно появятся в сделках;
- Bonus и Warehouse лучше строить после появления сценария продажи.
